...
public class PatternGraphTest {
	public static List<QueryVertex> sampleQueryVertices() {
		return Arrays.asList(
				new QueryVertex(new VertexId(1L), new VertexPredicate(VertexPredicate.Type.ATTR, 1)),
				new QueryVertex(new VertexId(2L), new VertexPredicate(VertexPredicate.Type.ID, new VertexId(1L))),
				new QueryVertex(new VertexId(3L), new VertexPredicate(VertexPredicate.Type.ATTR, 2))
				);
	}
